...
const footerLinks = [
  ...
  { href: profile.socials.hackerrank, Icon: HackerRankIcon, label: "HackerRank" },
  { href: profile.socials.codechef, Icon: CodeChefIcon, label: "CodeChef" },
  { href: profile.socials.skillrack, Icon: SkillRackIcon, label: "SkillRack" },
    ...
    <footer className="py-10 border-t border-border">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col items-center gap-6">
        ...
        <p className="text-sm text-muted-foreground text-center">
          © 2026 <span className="text-gradient font-semibold">Sandhya</span>. All Rights Reserved.
        </p>
      </div>
    </footer>
  );
